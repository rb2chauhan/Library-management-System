...
public class ShowIssueBooksTable implements ActionListener
{
 JFrame jf1;
 private JTable tb1;
 private JButton b1;
 int i,j,p=0;
 public  ShowIssueBooksTable()
 { 
   jf1=new JFrame();
   ...
   try
  {
     ...
     ResultSet rs1=stmt1.executeQuery("select * from IssueBooks");  
 ...
 {
  ShowIssueBooksTable tb2=new ShowIssueBooksTable();
